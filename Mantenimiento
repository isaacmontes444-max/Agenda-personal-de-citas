...
Error en la Visualización de Citas en el Calendario: En algunas fechas, el sistema no muestra las citas correctamente, especialmente en dispositivos móviles.
Fallo en el Recordatorio de Citas: Los recordatorios de citas no se envían en el tiempo estipulado, lo que provoca que los usuarios olviden sus citas.
Plan de Acción:
...
Cambios Necesarios:
Compatibilidad con Nuevas Versiones de Sistemas Operativos: El sistema debe ser compatible con las últimas versiones de Android e iOS.
Integración con Nuevas APIs: Se desea integrar la aplicación con una nueva API de recordatorios de Google para mejorar la sincronización de citas.
Plan de Acción:
...
Mejoras Propuestas:
Mejorar la Interfaz de Usuario: Rediseñar la interfaz para mejorar la experiencia del usuario, haciendo que sea más intuitiva y visualmente atractiva.
Optimización del Rendimiento: Mejorar el rendimiento del sistema en dispositivos con pocos recursos, asegurando tiempos de respuesta más rápidos.
Nueva Funcionalidad - Sincronización de Citas: Permitir que los usuarios puedan sincronizar sus citas con sus calendarios de Google y Outlook.
Plan de Acción:
